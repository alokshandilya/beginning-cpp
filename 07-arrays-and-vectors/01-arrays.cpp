...
int main() {
  ...
  // no size in [] so, compiler will size it based on the initializer list, here
  // size will be 5 (from 0 to 4).
  ...
  // int testScores [5];
  // will produce junk -> garbage values if printed (depends on environment)..
