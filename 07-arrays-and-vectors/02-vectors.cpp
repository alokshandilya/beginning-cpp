...
int main() {
  ...
  // vector_2d.at(0).at(0) is the integer at column 0 in the Row 0 vector which
  // is: {1, 2, 3, 4, 5} 
  // vector_2d.at(0).at(2) is the integer at column 2 in the
  // Row 0 vector which is: {1, 2, 3, 4, 5} 
  // vector_2d.at(2).at(1) is the integer
  // at column 1 in the Row 2 vector which is: {100, 200, 300}
