...
/*
    ...
    Your challenge for section 11 is to modularize your solution to the Section
    9 challenge by refactoring your solution so that it uses uses functions.

    You decide how to modularize the program.
    you can use my solution which is included in this file, or modularize your
    solution.
    ...
    Here are a few hints:
        ...
        - Keep the vector declaration in the main function and pass the vector
        object to any function that requires it
    ...
    DO NOT move the vector object outside main and make it a global variable.
        ...
        - Create functions that display the list of numbers, calculates the mean
        and so forth
...
/*
    ...
    in the list. If the list is empty you should display "[] - the list is
    empty" If the list is not empty then all the list element should be
    displayed inside square brackets separated by a space. For example,if
    [ 1 2 3 4 5 ]
    ...
    Additional functionality if you wish to extend this program.
        ...
        - search for a number in the list and if found display the number of
        times it occurs in the list
        - clearing out the list (make it empty again) (Hint: the vector class
        has a .clear() method)
...
void handle_smallest(const vector<int> &v) {
    if (v.size() == 0)
        ...
        cout << "The smallest element in the list is " << get_smallest(v)
             << endl;
}
...
//
// Enter your choice: a
// Enter an integer to add to the list: 7
// 7 added
//
// P - Print numbers
// A - Add a number
...
//
// Enter your choice: a
// Enter an integer to add to the list: 6
// 6 added
//
// P - Print numbers
// A - Add a number
