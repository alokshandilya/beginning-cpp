...
void print_array(const int arr[], size_t size) { // const
  for (size_t i{0}; i < size; ++i)
    cout << arr[i] << " ";
  cout << endl;
  // arr[0] = 50000; // bug [hence used const]
}
...
int main() {
  ...
  // as location of array is passed -> the function can modify the actual array.
  // const can be used so, we get compiler error and can debug it.
