...
int main() {
  ...
  // 100 = myNum1;
  // shows error because 100 is a literal and doesn't have a lvalue(location in
  // memory). 01-assignment_operator.cpp: In function ‘int main()’:
  // 01-assignment_operator.cpp:37:3: error: lvalue required as left operand of
  // assignment
  //  37 |   100 = myNum1;
  //     |   ^~~
