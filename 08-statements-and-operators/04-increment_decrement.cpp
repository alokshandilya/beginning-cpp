...
int main() {
  ...
  result = 0;
  cout << "Counter : " << counter << endl; // outputs 10
  result = ++counter; // Note the pre increment.. first value is increased by 1
                      // and then it binds to result hence , it will store 11.
                      // this is same as ->
                      // counter = counter + 1;
                      // result = counter;
  cout << "Counter : " << counter << endl; // outputs 11
  ...
  result = 0;
  cout << "Counter : " << counter << endl; // outputs 10
  result = counter++; // Note the post increment.. first counter value 10 binds
                      // to results and then counter becomes 11
                      // this is same as ->
                      // result = counter;
                      // counter = counter + 1;
  cout << "Counter : " << counter << endl; // outputs 11
  ...
  result = 0;
  cout << "Counter : " << counter << endl; // outputs 10
  result = ++counter + 10; // Note the pre increment.. so counter becomes 11 and
