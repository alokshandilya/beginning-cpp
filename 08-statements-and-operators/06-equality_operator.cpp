...
int main() {
    ...
    cout << "Comparision result (equals) : " << equal_result << endl;
    cout << "Comparision result (not equals) : " << not_equal_result << endl;
    // Remember that something like 12 and 11.9999999999999999999999999 will
    // show equal if we want very high precision we use special libraries for
    // that purpose.
...
// 7 7.000000000000000000000000000000000000000001 Comparision result (equals) :
// true Comparision result (not equals) : false
