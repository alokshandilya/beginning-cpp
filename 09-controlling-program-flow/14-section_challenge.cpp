...
in the list. If the list is empty you should display "[] - the list is empty" If
...
to add to the list which you will add to the list and then display it was added.
  For example, if the user enters 5 You should display, "5 added". Duplicate
list entries are OK
...
order they should be done. Think about what loops you should use as well as what
you will use for your selection logic.
...
//
// Enter your choice: A
// Enter an integer to add to the list: 78
// 78 added
//
// P - Print numbers
// A - Add a number
