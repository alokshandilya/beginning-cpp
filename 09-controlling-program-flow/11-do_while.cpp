...
int main() {
  ...
  // if the selection is equal to 'q' then the first part of the condition
  // fails, so the second part will be evaluated and it will be true.So the
  // entire condition evaluates to true and we continue looping.cout << endl;
  return 0;
}
