...
using std::cout;
using std::endl;
using std::fixed;        // standard namespace
using std::setprecision; // standard namespace
...
// Enter length, width, and height of the package separated by spaces : 5 7 8
// Adding tier 1 surcharge
// The volume of your package is: 280
// Your package will cost $2.75 to ship
