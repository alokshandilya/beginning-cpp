...
/*
 ...
 message. Then decryped the encrypted message back to the original message. You
 may use the 2 strings below for  your substitition. For example, to encrypt you
 can replace the character at position n in alphabet with the character at
 position n in key. To decrypt you can replace the character at position n in
 key with the character at position n in alphabet.
 ...
 could also be improved. Remember, the less code you write the less code you
 have to test! Reuse existing functionality in libraries and in the std::string
 class!
*/
...
// output
//
// Enter your secret message : Alok Shandilya
//
// Encrypting message...
//
// Encrypted message: xDTQ[oGXVLJDSX
//
// Decrypting message...
//
// Decrypted message: Alok Shandilya
