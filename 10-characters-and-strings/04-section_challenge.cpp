...
position n in key. To decrypt you can replace the character at position n in key
...
could also be improved. Remember, the less code you write the less code you have
to test! Reuse existing functionality in libraries and in the std::string class!
*/
