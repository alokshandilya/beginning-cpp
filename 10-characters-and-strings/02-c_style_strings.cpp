...
int main() {
  ...
  // but int or long etc.. based on machine)
  ...
  // case. (extraction operation ,cin stops on whitespace), and also the program
  // will take Shandilya and the program can take that Shandilya as input in
