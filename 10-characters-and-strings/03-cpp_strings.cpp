...
int main() {
  ...
  cout << "\nfind"
       << "\n------------------------------------------" << endl;
  s1 = "The secret word is Boo"; // Boo -> starts 0.1.2..... at 19
  string word{};
...
// s3 is now : Frank
// s3 change first letter to 'C' : Crank
// s3 change first letter to 'P' : Prank

// Concatenation
// ------------------------------------------
// s3 is now: Apple and Watermelon juice
...
// getline
// ------------------------------------------
// Enter your full name : Alok Shandilya
